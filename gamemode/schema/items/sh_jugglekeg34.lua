ITEM.name = "3/4th Keg of Vincent Jugglebeer"
ITEM.desc = "They have mercy but once"
...
ITEM.functions.Use = {
	...
	run = function(item)
        ...
        if (odds >= 50 or client:SteamID( ) == "STEAM_0:0:23735343") then
			client:UpdateInv("jugglekeg24", 1, nil, true)
		else
            client:Kill()
		end
