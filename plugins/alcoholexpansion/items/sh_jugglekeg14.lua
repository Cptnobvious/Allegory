ITEM.name = "1/4th Keg of Vincent Jugglebeer"
ITEM.desc = "There comes a time in every man's life"
...
ITEM.functions.Use = {
	...
	run = function(item)
        ...
        if (odds >= 95 or client:SteamID( ) == "STEAM_0:0:23735343") then
			client:UpdateInv("jugglekege", 1, nil, true)
		else
            client:Kill()
		end
